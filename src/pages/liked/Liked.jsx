...
const Liked = ({likedMovies,likedTv,watchL,watchLTv, setLikedMovies, setWatchL, setUpdate}) => {
    ...
    const fetchingData = async () => {
        try {
            ...
            for (let i = 0; i < likedTv?.length; i++) {
              const movieId = likedTv[i];
              try {
    ...
    <ContentWrapper>
        <div className="pageHeader">
            <div className="pageTitle">
               Liked {mediaType === "movie" ? "Movies" : "Tv Shows"}
            </div>
